![](pmpro-user-pages-banner.png)

# [Paid Memberships Pro - User Pages](https://www.paidmembershipspro.com/add-ons/pmpro-user-pages) #
...
1. Download the current development ZIP file directly: `https://github.com/strangerstudios/pmpro-user-pages/archive/dev.zip`
...
## Contributing to Paid Memberships Pro - User Pages ##
We encourage and welcome any contribution to Paid Memberships Pro - User Pages. Please read the [guidelines for contributing](https://github.com/strangerstudios/pmpro-user-pages/blob/dev/.github/CONTRIBUTING.md) to this repository.
